...
for rel in ['AGENTS.md','.grok/config.toml','scripts/connect-n8n.sh','scripts/update-skills.sh','.grok-plugin/marketplace.json','plugins/n8n-master-grok-bot/plugin.json']:
